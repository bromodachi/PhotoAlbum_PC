...
public interface IPhoto extends Serializable{
	...
	/**
	 * Injective tagging retrieval is necessary for tags associated with only one value (1-1 relationship).  This is for properties such as location -> <location>, 
	...
	/**
	 * Injective tagging association is necessary for tags to be associated with only one value (1-1 relationship).
	 * 
	...
	/**
	 * Surjective tagging retrieval is necessary for tags associated with multiple values (one-to-many relationship).  This is for properties such as people -> <List-Of-People>
	 * 
	...
	/**
	 * Surjective tagging association is necessary for tags to be associated with multiple values (one-to-many relationship).
	 * 
