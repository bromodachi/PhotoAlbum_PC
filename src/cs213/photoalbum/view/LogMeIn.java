 ...
 *         </p>
 */
public class LogMeIn extends LoginView {
	...
	private void setup() {
		...
		//TODO Remove this auxiliary layout.
		//this.titleLbl.setBorder(BorderFactory.createLineBorder(Color.black));
		//this.loginControls.setBorder(BorderFactory.createLineBorder(Color.black));
